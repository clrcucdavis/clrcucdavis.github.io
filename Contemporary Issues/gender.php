  ...
  <body>
    <div id="container">
      ...
      <div id="subcontainer">
        ...
        <div id="content">
          <h2>UC Research on Chicanas, Latinas, and Native/Indigenous Women<br />
</h2>
          <h3>Websites</h3>
          <ul class="tight">
          <ul>
            <li><a href="http://wms.ucdavis.edu/ggisite/">Gender and Global Issues, UC Davis</a></li>
            <li><a href="http://www.sa.ucsb.edu/women'scenter/">Women's Center, UCSB</a></li>
            <li><a href="http://www.csw.ucla.edu/">Center for the Study of Women, UCLA</a></li>
            <li><a href="http://www2.ucsc.edu/wmcenter/">Women's Center, UC Santa Cruz</a></li>
            <li><a href="http://wrrc.ucdavis.edu/">Women's Resources and Recearch Center, UC Davis</a></li>
            <li><a href="http://wrc.ucr.edu/">Women's Resource Center, UC Riverside</a></li>
            <li><a href="http://women.ucsd.edu/">Women's Center, UC San Diego</a></li>
          </ul>
          <h3>Researchers</h3>
          <div id="search">
            <form action="gender.php" method="get" accept-charset="utf-8">
