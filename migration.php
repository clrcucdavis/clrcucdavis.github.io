      ...
      <div id="subcontainer">
        <div id="menu">
          <ul>
            ...
            <li><a href="migration.php">Contemporary Issues</a></li>
            <li><a href="links.htm">Resources</a></li>
            <li><a href="index.htm">Home</a></li>            
          </ul>
        </div>
        <div id="content">
          <h2>UC Resources on Latin American Migration</h2>
          
          <h3>Websites</h3>
          <ul class="tight">
            <li><a href="http://migration.ucdavis.edu/" title="Migration Dialogue">UC Davis Migration Dialogue</a></li>
            <li><a href="http://www.sscnet.ucla.edu/soc/groups/migration" title="UCLA Migration Study Group">UCLA Migration Study Group</a></li>
            <li><a href="http://www.law.ucdavis.edu/alumni/ILCAC.aspx">Immigration Law Clinic</a></li>
            <li><a href="http://ccis.ucsd.edu/" title="CCIS Home Page">Center for Comparative Migration Studies</a></li>
          </ul>
          
          <h3>Researchers</h3>
          <div id="search">
            <form action="migration.php" method="get" accept-charset="utf-8">
